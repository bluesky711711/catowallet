            	...
            	<div class="row">
                    ...
                    <div class="col-md-9">
                    	<div class="form_header_right">
                            ...
                            <span><a class="btn btn-default" href="/login">login</a></span>
                        </div>
                    </div>
                </div>
            </div>
        	...
        	<div class="row">
            	<div class="col-md-6">
                	...
                	<div class="form_content">
                    	<h2>Signup <span>Register your account</span></h2>
                        <div class="row">
                            <div class="col-sm-12">
                              <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form_block">
                                    ...
                                    <input type="text" autocomplete="off" placeholder="User Name" name="name" required/></span>
                                </div>
                                <div class="form_block">
                                    <span><i class="ti-email"></i>
                                    <input type="email" autocomplete="off" placeholder="Email" name="email" required/></span>
                                </div>
                                <div class="form_block">
                                ...
                                <div class="form_block">
                                    <span><i class="ti-key"></i>
                                    <input type="password" autocomplete="off" placeholder="Retype Password" name="password_confirmation" required/></span>
                                </div>
                                <div class="form_block">
                                    <span><i class="ti-user"></i>
                                    <input type="text" autocomplete="off" placeholder="Sponser" /></span>
                                </div>
                                <div class="check_box">
                                    <span><input type="checkbox" autocomplete="off" /> I agree to the terms and conditions</span>
                                </div>
